...
protocol ShowContainerViewDelegate {
...
class MenuBar: UIView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    let cellId = "cellId"
    let imageNames = ["user", "picture"]
    var containerViewDelegate: ShowContainerViewDelegate!
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        containerViewDelegate.menuBarTapped(indexPath: indexPath)
    }
...
class MenuCell: BaseCell {
    let imageView: UIImageView = {
        let iv = UIImageView()
        iv.image = UIImage(named: "user")?.withRenderingMode(.alwaysTemplate)
    ...
    override func setupViews() {
        ...
        addConstraintsWithFormat(format: "H:[v0(45)]", views: imageView)
        addConstraintsWithFormat(format: "V:[v0(45)]", views: imageView)
